<nav class="bg-white h-12 shadow mb-8 px-6 md:px-0">
    <div class="container mx-auto h-full">
        <div class="flex items-center justify-center h-12">
            <div class="mr-6">
                <a href="{{ url('/') }}" class="no-underline font-bold text-xl text-grey-darker">
            ...
            <div class="flex-1 text-right">
                @guest
                    ...
                    <a class="no-underline hover:underline text-grey-darker pr-3 text-sm" href="{{ url('/register') }}">Register</a>
                @else
